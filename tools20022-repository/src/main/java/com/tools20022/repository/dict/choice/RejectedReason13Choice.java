...
import com.tools20022.repository.dict.choice.RejectedReason22Choice;
 ...
 */
@PreviousVersion(RejectedReason9Choice.class)
@NextVersion(RejectedReason22Choice.class)
