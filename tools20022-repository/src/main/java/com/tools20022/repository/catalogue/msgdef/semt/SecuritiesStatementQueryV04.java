...
import com.tools20022.repository.dict.msg.AdditionalQueryParameters7;
 ...
 */
@PreviousVersion(SecuritiesStatementQueryV03.class)
@NextVersion(SecuritiesStatementQueryV05.class)
public class SecuritiesStatementQueryV04 {
	...
	private Optional<AdditionalQueryParameters7> AdditionalQueryParameters;
	...
	public Optional<AdditionalQueryParameters7> getAdditionalQueryParameters() {
		return AdditionalQueryParameters;
	}

	public void setAdditionalQueryParameters(
			Optional<AdditionalQueryParameters7> AdditionalQueryParameters) {
