...
import com.tools20022.repository.dict.msg.AdditionalQueryParameters5;
 ...
 */
@PreviousVersion(SecuritiesStatementQueryV02.class)
@NextVersion(SecuritiesStatementQueryV04.class)
public class SecuritiesStatementQueryV03
	...
	private Optional<AdditionalQueryParameters5> AdditionalQueryParameters;
	...
	public Optional<AdditionalQueryParameters5> getAdditionalQueryParameters() {
		return AdditionalQueryParameters;
	}

	public void setAdditionalQueryParameters(
			Optional<AdditionalQueryParameters5> AdditionalQueryParameters) {
