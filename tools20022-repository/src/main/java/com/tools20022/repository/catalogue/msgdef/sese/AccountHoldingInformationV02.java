...
import com.tools20022.repository.catalogue.msgdef.sese.PEPOrISAOrPortfolioInformationV01;
...
import com.tools20022.repository.dict.msg.ISATransfer4;
 ...
 * on behalf of a client. Usage The AccountHoldingInformation message is used to
 * provide information about one or more ISA or portfolio products held in a
 * client's account.
 */
@PreviousVersion(PEPOrISAOrPortfolioInformationV01.class)
@NextVersion(AccountHoldingInformationV03.class)
public class AccountHoldingInformationV02 {
	...
	private ISATransfer4 ProductTransfer;
	...
	public ISATransfer4 getProductTransfer() {
		return ProductTransfer;
	}

	public void setProductTransfer(ISATransfer4 ProductTransfer) {
