...
import com.tools20022.repository.catalogue.msgdef.semt.SecuritiesBalanceCustodyReportV06;
...
import com.tools20022.repository.dict.msg.AggregateBalanceInformation16;
import com.tools20022.repository.dict.msg.SubAccountIdentification22;
 ...
 * “CoexistenceXxxxRule”.
 */
@PreviousVersion(SecuritiesBalanceCustodyReportV04.class)
@NextVersion(SecuritiesBalanceCustodyReportV06.class)
public class SecuritiesBalanceCustodyReportV05 {
	...
	private Optional<AggregateBalanceInformation16> BalanceForAccount;
	private Optional<SubAccountIdentification22> SubAccountDetails;
	...
	public Optional<AggregateBalanceInformation16> getBalanceForAccount() {
		return BalanceForAccount;
	}

	public void setBalanceForAccount(
			Optional<AggregateBalanceInformation16> BalanceForAccount) {
		this.BalanceForAccount = BalanceForAccount;
	}

	public Optional<SubAccountIdentification22> getSubAccountDetails() {
		return SubAccountDetails;
	}

	public void setSubAccountDetails(
			Optional<SubAccountIdentification22> SubAccountDetails) {
