...
import com.tools20022.repository.catalogue.msgdef.pain.CustomerPaymentStatusReportV08;
...
import com.tools20022.repository.dict.msg.OriginalPaymentInstruction18;
 ...
 * scenarios.
 */
@PreviousVersion(CustomerPaymentStatusReportV06.class)
@NextVersion(CustomerPaymentStatusReportV08.class)
public class CustomerPaymentStatusReportV07 {
	...
	private Optional<OriginalPaymentInstruction18> OriginalPaymentInformationAndStatus;
	...
	public Optional<OriginalPaymentInstruction18> getOriginalPaymentInformationAndStatus() {
		return OriginalPaymentInformationAndStatus;
	}

	public void setOriginalPaymentInformationAndStatus(
			Optional<OriginalPaymentInstruction18> OriginalPaymentInformationAndStatus) {
