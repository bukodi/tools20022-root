 ...
 */
@PreviousVersion(FIToFIPaymentReversalV06.class)
public class FIToFIPaymentReversalV07 {
	...
	private Optional<PaymentTransaction81> TransactionInformation;
	...
	public Optional<PaymentTransaction81> getTransactionInformation() {
		return TransactionInformation;
	}

	public void setTransactionInformation(
			Optional<PaymentTransaction81> TransactionInformation) {
