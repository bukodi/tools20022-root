...
import com.tools20022.repository.catalogue.msgdef.semt.IntraPositionMovementPostingReportV01;
...
import com.tools20022.repository.dict.msg.FinancialInstrumentDetails6;
 ...
 */
@PreviousVersion(IntraPositionMovementPostingReportV01.class)
@NextVersion(IntraPositionMovementPostingReportV03.class)
public class IntraPositionMovementPostingReportV02
	...
	private Optional<FinancialInstrumentDetails6> FinancialInstrument;
	...
	public Optional<FinancialInstrumentDetails6> getFinancialInstrument() {
		return FinancialInstrument;
	}

	public void setFinancialInstrument(
			Optional<FinancialInstrumentDetails6> FinancialInstrument) {
