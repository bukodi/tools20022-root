...
import com.tools20022.repository.catalogue.msgdef.semt.SecuritiesBalanceAccountingReportV05;
...
import com.tools20022.repository.dict.msg.Intermediary21;
import java.util.List;
import com.tools20022.repository.dict.msg.AggregateBalanceInformation13;
import com.tools20022.repository.dict.msg.SubAccountIdentification16;
 ...
 * “CoexistenceXxxxRule”.
 */
@PreviousVersion(SecuritiesBalanceAccountingReportV03.class)
@NextVersion(SecuritiesBalanceAccountingReportV05.class)
public class SecuritiesBalanceAccountingReportV04 {
	...
	private List<Intermediary21> IntermediaryInformation;
	private Optional<AggregateBalanceInformation13> BalanceForAccount;
	private Optional<SubAccountIdentification16> SubAccountDetails;
	...
	public void setIntermediaryInformation(
			List<Intermediary21> IntermediaryInformation) {
		this.IntermediaryInformation = IntermediaryInformation;
	}

	public Optional<AggregateBalanceInformation13> getBalanceForAccount() {
		return BalanceForAccount;
	}

	public void setBalanceForAccount(
			Optional<AggregateBalanceInformation13> BalanceForAccount) {
		this.BalanceForAccount = BalanceForAccount;
	}

	public Optional<SubAccountIdentification16> getSubAccountDetails() {
		return SubAccountDetails;
	}

	public void setSubAccountDetails(
			Optional<SubAccountIdentification16> SubAccountDetails) {
