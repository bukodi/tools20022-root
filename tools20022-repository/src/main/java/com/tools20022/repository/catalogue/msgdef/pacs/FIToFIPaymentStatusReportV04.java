...
import com.tools20022.repository.dict.msg.PaymentTransaction33;
 ...
 */
@PreviousVersion(FIToFIPaymentStatusReportV03.class)
@NextVersion(FIToFIPaymentStatusReportV05.class)
public class FIToFIPaymentStatusReportV04 {
	...
	private Optional<PaymentTransaction33> TransactionInformationAndStatus;
	...
	public Optional<PaymentTransaction33> getTransactionInformationAndStatus() {
		return TransactionInformationAndStatus;
	}

	public void setTransactionInformationAndStatus(
			Optional<PaymentTransaction33> TransactionInformationAndStatus) {
