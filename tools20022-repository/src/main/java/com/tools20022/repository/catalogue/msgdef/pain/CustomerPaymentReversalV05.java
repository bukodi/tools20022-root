...
import com.tools20022.repository.catalogue.msgdef.pain.CustomerPaymentReversalV04;
...
import com.tools20022.repository.dict.msg.OriginalPaymentInstruction11;
 ...
 */
@PreviousVersion(CustomerPaymentReversalV04.class)
@NextVersion(CustomerPaymentReversalV06.class)
public class CustomerPaymentReversalV05 {
	...
	private Optional<OriginalPaymentInstruction11> OriginalPaymentInformationAndReversal;
	...
	public Optional<OriginalPaymentInstruction11> getOriginalPaymentInformationAndReversal() {
		return OriginalPaymentInformationAndReversal;
	}

	public void setOriginalPaymentInformationAndReversal(
			Optional<OriginalPaymentInstruction11> OriginalPaymentInformationAndReversal) {
