...
import com.tools20022.repository.dict.msg.StatusAndReason16;
import com.tools20022.repository.dict.msg.Transaction27;
 ...
 */
@PreviousVersion(SecuritiesTransactionPendingReportV03.class)
@NextVersion(SecuritiesTransactionPendingReportV05.class)
public class SecuritiesTransactionPendingReportV04
	...
	private Optional<StatusAndReason16> Status;
	private Optional<Transaction27> Transactions;
	...
	public Optional<StatusAndReason16> getStatus() {
		return Status;
	}

	public void setStatus(Optional<StatusAndReason16> Status) {
		this.Status = Status;
	}

	public Optional<Transaction27> getTransactions() {
		return Transactions;
	}

	public void setTransactions(Optional<Transaction27> Transactions) {
