...
import com.tools20022.repository.catalogue.msgdef.semt.SecuritiesBalanceAccountingReportV06;
...
import com.tools20022.repository.dict.msg.AggregateBalanceInformation17;
import com.tools20022.repository.dict.msg.SubAccountIdentification23;
 ...
 * “CoexistenceXxxxRule”.
 */
@PreviousVersion(SecuritiesBalanceAccountingReportV04.class)
@NextVersion(SecuritiesBalanceAccountingReportV06.class)
public class SecuritiesBalanceAccountingReportV05
	...
	private Optional<AggregateBalanceInformation17> BalanceForAccount;
	private Optional<SubAccountIdentification23> SubAccountDetails;
	...
	public Optional<AggregateBalanceInformation17> getBalanceForAccount() {
		return BalanceForAccount;
	}

	public void setBalanceForAccount(
			Optional<AggregateBalanceInformation17> BalanceForAccount) {
		this.BalanceForAccount = BalanceForAccount;
	}

	public Optional<SubAccountIdentification23> getSubAccountDetails() {
		return SubAccountDetails;
	}

	public void setSubAccountDetails(
			Optional<SubAccountIdentification23> SubAccountDetails) {
