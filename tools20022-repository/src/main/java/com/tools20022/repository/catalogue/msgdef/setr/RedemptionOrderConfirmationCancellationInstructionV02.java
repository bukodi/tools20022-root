...
import com.tools20022.repository.catalogue.msgdef.setr.RedemptionOrderConfirmationCancellationInstructionV01;
...
/**
 * Scope The RedemptionOrderConfirmationCancellationInstruction message is sent
 ...
 * to cancel a previously sent RedemptionOrderConfirmation. Usage To request the
 * cancellation of one or more individual order executions, the order reference
 * and deal reference of each individual order execution in the original
 * RedemptionOrderConfirmation are specified in the order reference and deal
 * reference elements respectively. The message identification of the
 ...
 * the value ‘true’.
 */
@PreviousVersion(RedemptionOrderConfirmationCancellationInstructionV01.class)
