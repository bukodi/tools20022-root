...
import com.tools20022.repository.catalogue.msgdef.pacs.FIToFIPaymentReversalV06;
 ...
 */
@PreviousVersion(FIToFIPaymentReversalV04.class)
@NextVersion(FIToFIPaymentReversalV06.class)
public class FIToFIPaymentReversalV05
	...
	private Optional<PaymentTransaction51> TransactionInformation;
	...
	public Optional<PaymentTransaction51> getTransactionInformation() {
		return TransactionInformation;
	}

	public void setTransactionInformation(
			Optional<PaymentTransaction51> TransactionInformation) {
