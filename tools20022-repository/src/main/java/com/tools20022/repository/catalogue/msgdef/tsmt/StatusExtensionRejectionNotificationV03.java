...
/**
 * Scope The StatusExtensionRejectionNotification message is sent by the
 * matching application to the submitter of a request to extend the status of a
 * transaction. This message is used to inform about the rejection of a request
 * to extend the status of a transaction. Usage The
 * StatusExtensionRejectionNotification message can be sent by the matching
 ...
 * StatusExtensionRejection message. In order to pass on information about the
 * acceptance of a request to extend the status of a transaction the matching
 * application sends a StatusExtensionNotification message
 */
public class StatusExtensionRejectionNotificationV03 {
	...
	private TransactionStatus4 NonExtendedStatus;
