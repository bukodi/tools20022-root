...
import com.tools20022.repository.catalogue.msgdef.semt.SecuritiesTransactionPendingReportV04;
...
import com.tools20022.repository.dict.msg.StatusAndReason18;
import com.tools20022.repository.dict.msg.Transaction34;
 ...
 */
@PreviousVersion(SecuritiesTransactionPendingReportV04.class)
@NextVersion(SecuritiesTransactionPendingReportV06.class)
public class SecuritiesTransactionPendingReportV05 {
	...
	private Optional<StatusAndReason18> Status;
	private Optional<Transaction34> Transactions;
	...
	public Optional<StatusAndReason18> getStatus() {
		return Status;
	}

	public void setStatus(Optional<StatusAndReason18> Status) {
		this.Status = Status;
	}

	public Optional<Transaction34> getTransactions() {
		return Transactions;
	}

	public void setTransactions(Optional<Transaction34> Transactions) {
