...
import com.tools20022.repository.dict.msg.AggregateBalanceInformation22;
import com.tools20022.repository.dict.msg.SubAccountIdentification29;
 ...
 */
@PreviousVersion(SecuritiesBalanceAccountingReportV06.class)
@NextVersion(SecuritiesBalanceAccountingReportV08.class)
public class SecuritiesBalanceAccountingReportV07 {
	...
	private Optional<AggregateBalanceInformation22> BalanceForAccount;
	private Optional<SubAccountIdentification29> SubAccountDetails;
	...
	public Optional<AggregateBalanceInformation22> getBalanceForAccount() {
		return BalanceForAccount;
	}

	public void setBalanceForAccount(
			Optional<AggregateBalanceInformation22> BalanceForAccount) {
		this.BalanceForAccount = BalanceForAccount;
	}

	public Optional<SubAccountIdentification29> getSubAccountDetails() {
		return SubAccountDetails;
	}

	public void setSubAccountDetails(
			Optional<SubAccountIdentification29> SubAccountDetails) {
