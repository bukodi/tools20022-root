...
import com.tools20022.repository.dict.msg.SecuritiesTradeDetails23;
 ...
 */
@PreviousVersion(SecuritiesSettlementTransactionAllegementReportV02.class)
@NextVersion(SecuritiesSettlementTransactionAllegementReportV04.class)
public class SecuritiesSettlementTransactionAllegementReportV03
	...
	private Optional<SecuritiesTradeDetails23> AllegementDetails;
	...
	public Optional<SecuritiesTradeDetails23> getAllegementDetails() {
		return AllegementDetails;
	}

	public void setAllegementDetails(
			Optional<SecuritiesTradeDetails23> AllegementDetails) {
