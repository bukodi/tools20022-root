...
import com.tools20022.repository.dict.msg.RequestDetails8;
 ...
 */
@PreviousVersion(SecuritiesSettlementConditionModificationStatusAdviceV02.class)
@NextVersion(SecuritiesSettlementConditionModificationStatusAdviceV04.class)
public class SecuritiesSettlementConditionModificationStatusAdviceV03
	...
	private Optional<RequestDetails8> RequestDetails;
	...
	public Optional<RequestDetails8> getRequestDetails() {
		return RequestDetails;
	}

	public void setRequestDetails(Optional<RequestDetails8> RequestDetails) {
