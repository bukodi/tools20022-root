...
import com.tools20022.repository.dict.msg.ISATransfer10;
 ...
 */
@PreviousVersion(PortfolioTransferConfirmationV03.class)
@NextVersion(PortfolioTransferConfirmationV05.class)
public class PortfolioTransferConfirmationV04 {
	...
	private ISATransfer10 ProductTransfer;
	...
	public ISATransfer10 getProductTransfer() {
		return ProductTransfer;
	}

	public void setProductTransfer(ISATransfer10 ProductTransfer) {
