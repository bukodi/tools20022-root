...
import com.tools20022.repository.catalogue.msgdef.sese.AccountHoldingInformationV02;
...
import com.tools20022.repository.dict.msg.PEPISATransfer6;
 ...
 * behalf of a client. Usage The PEPOrISAOrPortfolioInformation message is used
 * to provide information about one or more PEP or ISA or portfolio products
 * held in a client's account.
 */
@NextVersion(AccountHoldingInformationV02.class)
public class PEPOrISAOrPortfolioInformationV01
	...
	private PEPISATransfer6 ProductTransfer;
	...
	public PEPISATransfer6 getProductTransfer() {
		return ProductTransfer;
	}

	public void setProductTransfer(PEPISATransfer6 ProductTransfer) {
