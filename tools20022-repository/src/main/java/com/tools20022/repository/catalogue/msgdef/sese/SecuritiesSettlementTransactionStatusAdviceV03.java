...
import com.tools20022.repository.catalogue.msgdef.sese.SecuritiesSettlementTransactionStatusAdviceV04;
import com.tools20022.core.repo.NextVersion;
import com.tools20022.repository.dict.msg.TransactionIdentifications16;
import com.tools20022.repository.dict.choice.ProcessingStatus19Choice;
import java.util.Optional;
import com.tools20022.repository.dict.choice.MatchingStatus7Choice;
import com.tools20022.repository.dict.choice.SettlementStatus7Choice;
import com.tools20022.repository.dict.msg.TransactionDetails36;
 ...
 */
@PreviousVersion(SecuritiesSettlementTransactionStatusAdviceV02.class)
@NextVersion(SecuritiesSettlementTransactionStatusAdviceV04.class)
public class SecuritiesSettlementTransactionStatusAdviceV03 {
	...
	private Optional<ProcessingStatus19Choice> ProcessingStatus;
	private Optional<MatchingStatus7Choice> InferredMatchingStatus;
	private Optional<MatchingStatus7Choice> MatchingStatus;
	private Optional<SettlementStatus7Choice> SettlementStatus;
	private Optional<TransactionDetails36> TransactionDetails;
	...
	public void setProcessingStatus(
			Optional<ProcessingStatus19Choice> ProcessingStatus) {
	...
	public void setInferredMatchingStatus(
			Optional<MatchingStatus7Choice> InferredMatchingStatus) {
	...
	public void setMatchingStatus(Optional<MatchingStatus7Choice> MatchingStatus) {
	...
	public Optional<TransactionDetails36> getTransactionDetails() {
		return TransactionDetails;
	}

	public void setTransactionDetails(
			Optional<TransactionDetails36> TransactionDetails) {
