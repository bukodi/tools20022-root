...
import com.tools20022.repository.catalogue.msgdef.camt.ResolutionOfInvestigationV03;
...
import com.tools20022.repository.dict.msg.UnderlyingTransaction4;
 ...
 */
@PreviousVersion(ResolutionOfInvestigationV03.class)
@NextVersion(ResolutionOfInvestigationV05.class)
public class ResolutionOfInvestigationV04 {
	...
	private Optional<UnderlyingTransaction4> CancellationDetails;
	...
	public Optional<UnderlyingTransaction4> getCancellationDetails() {
		return CancellationDetails;
	}

	public void setCancellationDetails(
			Optional<UnderlyingTransaction4> CancellationDetails) {
