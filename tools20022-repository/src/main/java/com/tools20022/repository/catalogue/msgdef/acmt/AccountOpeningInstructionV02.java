...
import com.tools20022.repository.dict.msg.InvestmentAccount26;
 ...
 * sends the AccountOpeningInstruction message to an account servicer, for
 ...
 */
@NextVersion(AccountOpeningInstructionV03.class)
public class AccountOpeningInstructionV02
	...
	private InvestmentAccount26 InvestmentAccount;
	private AccountParties5 AccountParties;
