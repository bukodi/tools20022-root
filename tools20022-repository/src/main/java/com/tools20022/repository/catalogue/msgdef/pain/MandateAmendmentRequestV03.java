...
import com.tools20022.repository.dict.msg.MandateAmendment3;
 ...
 */
@PreviousVersion(MandateAmendmentRequestV02.class)
@NextVersion(MandateAmendmentRequestV04.class)
public class MandateAmendmentRequestV03
		implements
			GeneratedRepoBean<MMMessageDefinition> {

	private GroupHeader47 GroupHeader;
	private MandateAmendment3 UnderlyingAmendmentDetails;
	...
	public MandateAmendment3 getUnderlyingAmendmentDetails() {
		return UnderlyingAmendmentDetails;
	}

	public void setUnderlyingAmendmentDetails(
			MandateAmendment3 UnderlyingAmendmentDetails) {
