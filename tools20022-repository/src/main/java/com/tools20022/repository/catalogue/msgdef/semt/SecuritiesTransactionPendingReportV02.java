...
import com.tools20022.repository.catalogue.msgdef.semt.SecuritiesTransactionPendingReportV01;
import com.tools20022.core.repo.PreviousVersion;
import com.tools20022.repository.catalogue.msgdef.semt.SecuritiesTransactionPendingReportV03;
...
import com.tools20022.repository.dict.msg.StatusAndReason7;
import com.tools20022.repository.dict.msg.Transaction12;
 ...
 */
@PreviousVersion(SecuritiesTransactionPendingReportV01.class)
@NextVersion(SecuritiesTransactionPendingReportV03.class)
public class SecuritiesTransactionPendingReportV02 {
	...
	private Optional<StatusAndReason7> Status;
	private Optional<Transaction12> Transactions;
	...
	public Optional<StatusAndReason7> getStatus() {
		return Status;
	}

	public void setStatus(Optional<StatusAndReason7> Status) {
		this.Status = Status;
	}

	public Optional<Transaction12> getTransactions() {
		return Transactions;
	}

	public void setTransactions(Optional<Transaction12> Transactions) {
