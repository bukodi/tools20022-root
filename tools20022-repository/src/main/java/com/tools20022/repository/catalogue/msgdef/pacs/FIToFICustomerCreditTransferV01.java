...
import com.tools20022.repository.dict.msg.GroupHeader2;
import com.tools20022.repository.dict.msg.CreditTransferTransactionInformation2;
 ...
 * scenarios.
 */
@NextVersion(FIToFICustomerCreditTransferV02.class)
public class FIToFICustomerCreditTransferV01
		implements
			GeneratedRepoBean<MMMessageDefinition> {

	private GroupHeader2 GroupHeader;
	private CreditTransferTransactionInformation2 CreditTransferTransactionInformation;

	public GroupHeader2 getGroupHeader() {
		return GroupHeader;
	}

	public void setGroupHeader(GroupHeader2 GroupHeader) {
		this.GroupHeader = GroupHeader;
	}

	public CreditTransferTransactionInformation2 getCreditTransferTransactionInformation() {
		return CreditTransferTransactionInformation;
	}

	public void setCreditTransferTransactionInformation(
			CreditTransferTransactionInformation2 CreditTransferTransactionInformation) {
