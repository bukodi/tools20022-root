...
import com.tools20022.repository.dict.choice.InvestigationStatus2Choice;
import com.tools20022.repository.dict.msg.UnderlyingTransaction3;
import com.tools20022.repository.dict.msg.StatementResolutionEntry1;
...
public class ResolutionOfInvestigationV03 {
	...
	private InvestigationStatus2Choice Status;
	private Optional<UnderlyingTransaction3> CancellationDetails;
	private Optional<StatementResolutionEntry1> StatementDetails;
	...
	public void setResolvedCase(Optional<Case2> ResolvedCase) {
	...
	public Optional<UnderlyingTransaction3> getCancellationDetails() {
		return CancellationDetails;
	}

	public void setCancellationDetails(
			Optional<UnderlyingTransaction3> CancellationDetails) {
	...
	public void setStatementDetails(
			Optional<StatementResolutionEntry1> StatementDetails) {
