...
import com.tools20022.repository.dict.msg.DeliverInformation9;
 ...
 */
@PreviousVersion(TransferInInstructionV03.class)
@NextVersion(TransferInInstructionV05.class)
public class TransferInInstructionV04
	...
	private Optional<DeliverInformation9> SettlementDetails;
	...
	public void setSettlementDetails(
			Optional<DeliverInformation9> SettlementDetails) {
