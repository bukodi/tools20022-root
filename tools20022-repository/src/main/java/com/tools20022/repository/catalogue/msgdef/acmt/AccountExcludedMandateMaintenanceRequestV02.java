...
import com.tools20022.repository.catalogue.msgdef.acmt.AccountExcludedMandateMaintenanceRequestV01;
 ...
 * update is about account details excluding any mandate information. If
 * modification codes are not used: the organisation will specify under the
 * “Account” and “Organisation” tags the complete information as it should be in
 * the financial institution’s records after processing the update request. If
 * modification codes are used (in that case, they must be used everywhere): the
 * organisation will specify under the “Account” and “Organisation” tags which
 * elements must be added, deleted, modified, or if they are unchanged.
 */
@PreviousVersion(AccountExcludedMandateMaintenanceRequestV01.class)
