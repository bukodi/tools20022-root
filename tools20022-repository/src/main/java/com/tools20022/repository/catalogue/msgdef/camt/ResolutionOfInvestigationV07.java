...
import com.tools20022.repository.dict.msg.UnderlyingTransaction17;
import com.tools20022.repository.dict.msg.StatementResolutionEntry2;
import com.tools20022.repository.dict.choice.CorrectiveTransaction2Choice;
 ...
 */
@PreviousVersion(ResolutionOfInvestigationV06.class)
public class ResolutionOfInvestigationV07
	...
	private Optional<UnderlyingTransaction17> CancellationDetails;
	private Optional<StatementResolutionEntry2> StatementDetails;
	private Optional<CorrectiveTransaction2Choice> CorrectionTransaction;
	...
	public Optional<UnderlyingTransaction17> getCancellationDetails() {
		return CancellationDetails;
	}

	public void setCancellationDetails(
			Optional<UnderlyingTransaction17> CancellationDetails) {
	...
	public void setCorrectionTransaction(
			Optional<CorrectiveTransaction2Choice> CorrectionTransaction) {
