 ...
 * previously sent SubscriptionOrderConfirmation. Usage The
 * SubscriptionOrderConfirmationAmendment message is used to amend one or more
 * previously sent subscription order confirmations. Each individual order
