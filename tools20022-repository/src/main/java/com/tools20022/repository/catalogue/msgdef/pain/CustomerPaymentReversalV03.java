...
import com.tools20022.repository.dict.msg.OriginalPaymentInstruction2;
 ...
 */
@PreviousVersion(CustomerPaymentReversalV02.class)
@NextVersion(CustomerPaymentReversalV04.class)
public class CustomerPaymentReversalV03
	...
	private Optional<OriginalPaymentInstruction2> OriginalPaymentInformationAndReversal;
	...
	public Optional<OriginalPaymentInstruction2> getOriginalPaymentInformationAndReversal() {
		return OriginalPaymentInformationAndReversal;
	}

	public void setOriginalPaymentInformationAndReversal(
			Optional<OriginalPaymentInstruction2> OriginalPaymentInformationAndReversal) {
