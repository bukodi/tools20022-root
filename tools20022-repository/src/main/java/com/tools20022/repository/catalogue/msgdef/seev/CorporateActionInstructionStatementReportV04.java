...
import com.tools20022.repository.dict.msg.AccountIdentification25;
 ...
 */
@PreviousVersion(CorporateActionInstructionStatementReportV03.class)
@NextVersion(CorporateActionInstructionStatementReportV05.class)
public class CorporateActionInstructionStatementReportV04
	...
	private AccountIdentification25 AccountAndStatementDetails;
	...
	public AccountIdentification25 getAccountAndStatementDetails() {
		return AccountAndStatementDetails;
	}

	public void setAccountAndStatementDetails(
			AccountIdentification25 AccountAndStatementDetails) {
