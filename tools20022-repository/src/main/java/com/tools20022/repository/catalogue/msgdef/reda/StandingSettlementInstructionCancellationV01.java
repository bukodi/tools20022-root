...
/**
 * Scope An instructing party sends the
 * StandingSettlementInstructionCancellation message to the receiver to cancel a
 * previously sent StandingSettlementInstruction message. The message can also
 * be used to notify a counterparty of the deletion of a standing settlement
 * information.
 * 
...
public class StandingSettlementInstructionCancellationV01 {
	...
	private Max35Text PreviousMessageReference;
