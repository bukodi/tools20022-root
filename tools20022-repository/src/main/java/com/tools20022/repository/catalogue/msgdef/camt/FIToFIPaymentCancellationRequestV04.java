...
import com.tools20022.repository.catalogue.msgdef.camt.FIToFIPaymentCancellationRequestV03;
import com.tools20022.core.repo.PreviousVersion;
import com.tools20022.repository.catalogue.msgdef.camt.FIToFIPaymentCancellationRequestV05;
...
import com.tools20022.repository.dict.msg.UnderlyingTransaction10;
 ...
 * set to 'Yes' or 'true'. The FIToFI Payment Cancellation Request message has
 ...
 * assignee(s). For the FIToFI Payment Cancellation Request message has been
 * made optional, as the message might be used outside of a case management
 ...
 */
@PreviousVersion(FIToFIPaymentCancellationRequestV03.class)
@NextVersion(FIToFIPaymentCancellationRequestV05.class)
public class FIToFIPaymentCancellationRequestV04 {
	...
	private UnderlyingTransaction10 Underlying;
	...
	public UnderlyingTransaction10 getUnderlying() {
		return Underlying;
	}

	public void setUnderlying(UnderlyingTransaction10 Underlying) {
