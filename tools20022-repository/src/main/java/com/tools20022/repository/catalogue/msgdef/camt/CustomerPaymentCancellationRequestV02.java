...
import com.tools20022.repository.dict.msg.UnderlyingTransaction6;
 ...
 * chain.
 */
@PreviousVersion(CustomerPaymentCancellationRequestV01.class)
@NextVersion(CustomerPaymentCancellationRequestV03.class)
public class CustomerPaymentCancellationRequestV02 {
	...
	private UnderlyingTransaction6 Underlying;
	...
	public UnderlyingTransaction6 getUnderlying() {
		return Underlying;
	}

	public void setUnderlying(UnderlyingTransaction6 Underlying) {
