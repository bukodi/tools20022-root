...
import com.tools20022.repository.dict.msg.SubscriptionBulkOrder2;
 ...
 * an investment manager or its authorised representative, to an executing
 ...
 * instruct the executing party to subscribe to a financial instrument, for two
 * or more accounts. Usage The SubscriptionBulkOrder message is used to bulk
 * several individual orders into one bulk order. The individual orders come
 * from different instructing parties, ie, account owners, but are related to
 * the same financial instrument. This message will be typically be used by a
 * party collecting orders and bulking these individual orders into one bulk
 * order before sending it to another party. For a single subscription order,
 * the SubscriptionMultipleOrder message, not the SubscriptionBulkOrder message,
 * must be used. If there are subscription orders for different financial
 * instruments but for the same account, then the SubscriptionMultipleOrder must
 * be used.
 */
@NextVersion(SubscriptionBulkOrderV03.class)
public class SubscriptionBulkOrderV02
	...
	private SubscriptionBulkOrder2 BulkOrderDetails;
	...
	public void setBulkOrderDetails(SubscriptionBulkOrder2 BulkOrderDetails) {
