...
import com.tools20022.repository.dict.msg.OriginalPaymentInstruction1;
 ...
 * scenarios.
 */
@PreviousVersion(CustomerPaymentStatusReportV03.class)
@NextVersion(CustomerPaymentStatusReportV05.class)
public class CustomerPaymentStatusReportV04 {
	...
	private Optional<OriginalPaymentInstruction1> OriginalPaymentInformationAndStatus;
	...
	public Optional<OriginalPaymentInstruction1> getOriginalPaymentInformationAndStatus() {
		return OriginalPaymentInformationAndStatus;
	}

	public void setOriginalPaymentInformationAndStatus(
			Optional<OriginalPaymentInstruction1> OriginalPaymentInformationAndStatus) {
