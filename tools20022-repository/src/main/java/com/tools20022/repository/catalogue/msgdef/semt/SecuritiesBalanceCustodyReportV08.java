...
import com.tools20022.repository.catalogue.msgdef.semt.SecuritiesBalanceCustodyReportV09;
...
import com.tools20022.repository.dict.msg.AggregateBalanceInformation25;
import com.tools20022.repository.dict.msg.SubAccountIdentification37;
 ...
 */
@PreviousVersion(SecuritiesBalanceCustodyReportV07.class)
@NextVersion(SecuritiesBalanceCustodyReportV09.class)
public class SecuritiesBalanceCustodyReportV08 {
	...
	private Optional<AggregateBalanceInformation25> BalanceForAccount;
	private Optional<SubAccountIdentification37> SubAccountDetails;
	...
	public Optional<AggregateBalanceInformation25> getBalanceForAccount() {
		return BalanceForAccount;
	}

	public void setBalanceForAccount(
			Optional<AggregateBalanceInformation25> BalanceForAccount) {
		this.BalanceForAccount = BalanceForAccount;
	}

	public Optional<SubAccountIdentification37> getSubAccountDetails() {
		return SubAccountDetails;
	}

	public void setSubAccountDetails(
			Optional<SubAccountIdentification37> SubAccountDetails) {
