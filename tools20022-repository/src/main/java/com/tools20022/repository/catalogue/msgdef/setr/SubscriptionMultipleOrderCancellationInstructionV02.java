...
import com.tools20022.repository.catalogue.msgdef.setr.SubscriptionOrderCancellationRequestV03;
import com.tools20022.core.repo.NextVersion;
import com.tools20022.repository.dict.msg.AdditionalReference3;
import java.util.Optional;
import com.tools20022.repository.dict.msg.SubscriptionMultipleOrderInstruction1;

/**
 * Scope The SubscriptionMultipleOrderCancellationInstruction message is sent by
 * an instructing party, eg, an investment manager or its authorised
 * representative , to an executing party, eg, a transfer agent. There may be
 * one or more intermediary parties between the instructing party and the
 * executing party. The intermediary party is, for example, an intermediary or a
 * concentrator. This message is sent to cancel a previously sent
 * SubscriptionMultipleOrder instruction. Usage The
 * SubscriptionMultipleOrderCancellationInstruction message is used to cancel
 * the entire previously sent SubscriptionMultipleOrder message and all the
 ...
 */
@NextVersion(SubscriptionOrderCancellationRequestV03.class)
public class SubscriptionMultipleOrderCancellationInstructionV02
	...
	private Optional<SubscriptionMultipleOrderInstruction1> OrderToBeCancelled;
	...
	public void setOrderToBeCancelled(
			Optional<SubscriptionMultipleOrderInstruction1> OrderToBeCancelled) {
