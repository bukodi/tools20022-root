...
import com.tools20022.repository.dict.msg.StatusAndReason9;
import com.tools20022.repository.dict.msg.Transaction19;
 ...
 */
@PreviousVersion(SecuritiesTransactionPendingReportV02.class)
@NextVersion(SecuritiesTransactionPendingReportV04.class)
public class SecuritiesTransactionPendingReportV03 {
	...
	private Optional<StatusAndReason9> Status;
	private Optional<Transaction19> Transactions;
	...
	public Optional<StatusAndReason9> getStatus() {
		return Status;
	}

	public void setStatus(Optional<StatusAndReason9> Status) {
		this.Status = Status;
	}

	public Optional<Transaction19> getTransactions() {
		return Transactions;
	}

	public void setTransactions(Optional<Transaction19> Transactions) {
