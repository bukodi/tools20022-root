...
import com.tools20022.repository.dict.choice.Cancellation4Choice;
 ...
 */
@PreviousVersion(TransferOutCancellationRequestV04.class)
@NextVersion(TransferOutCancellationRequestV06.class)
public class TransferOutCancellationRequestV05
	...
	private Cancellation4Choice Cancellation;
	...
	public Cancellation4Choice getCancellation() {
		return Cancellation;
	}

	public void setCancellation(Cancellation4Choice Cancellation) {
