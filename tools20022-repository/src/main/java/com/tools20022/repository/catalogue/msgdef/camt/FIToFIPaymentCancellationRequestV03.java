...
import com.tools20022.repository.dict.msg.UnderlyingTransaction8;
 ...
 */
@PreviousVersion(FIToFIPaymentCancellationRequestV02.class)
@NextVersion(FIToFIPaymentCancellationRequestV04.class)
public class FIToFIPaymentCancellationRequestV03 {
	...
	private UnderlyingTransaction8 Underlying;
	...
	public UnderlyingTransaction8 getUnderlying() {
		return Underlying;
	}

	public void setUnderlying(UnderlyingTransaction8 Underlying) {
