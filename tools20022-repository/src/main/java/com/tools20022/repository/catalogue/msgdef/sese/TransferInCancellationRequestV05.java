 ...
 * PreviousReference.
 */
@PreviousVersion(TransferInCancellationRequestV04.class)
@NextVersion(TransferInCancellationRequestV06.class)
public class TransferInCancellationRequestV05
	...
	private Cancellation5Choice Cancellation;
	...
	public Cancellation5Choice getCancellation() {
		return Cancellation;
	}

	public void setCancellation(Cancellation5Choice Cancellation) {
