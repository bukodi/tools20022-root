...
import com.tools20022.repository.dict.msg.Order17;
import com.tools20022.repository.dict.msg.SecurityIdentification14;
import com.tools20022.repository.dict.msg.FinancialInstrumentAttributes44;
import com.tools20022.repository.dict.msg.UnderlyingFinancialInstrument2;
...
import com.tools20022.repository.dict.msg.CashParties18;
 ...
 * SecuritiesAllocationInstruction message.
 * 
 ...
 * communicating on behalf of them, or their agent.
 * 
 * USAGE Initiator: In local matching, the initiator of this message is always
 * the executing party. In central matching the initiator may be either the
 * executing party or instructing party. Respondent: instructing party, a
 * custodian or an affirming party responds with
 * SecuritiesTradeConfirmationResponse (accept or reject) message.
 */
@PreviousVersion(SecuritiesTradeConfirmationV02.class)
public class SecuritiesTradeConfirmationV03 {
	...
	private Order17 TradeDetails;
	private SecurityIdentification14 FinancialInstrumentIdentification;
	private Optional<FinancialInstrumentAttributes44> FinancialInstrumentAttributes;
	private Optional<UnderlyingFinancialInstrument2> UnderlyingFinancialInstrument;
	...
	private Optional<CashParties18> CashParties;
	...
	private Optional<OtherPrices2> OtherPrices;
	...
	public void setFinancialInstrumentAttributes(
			Optional<FinancialInstrumentAttributes44> FinancialInstrumentAttributes) {
		this.FinancialInstrumentAttributes = FinancialInstrumentAttributes;
	}

	public Optional<UnderlyingFinancialInstrument2> getUnderlyingFinancialInstrument() {
		return UnderlyingFinancialInstrument;
	}

	public void setUnderlyingFinancialInstrument(
			Optional<UnderlyingFinancialInstrument2> UnderlyingFinancialInstrument) {
	...
	public void setCashParties(Optional<CashParties18> CashParties) {
	...
	public Optional<OtherPrices2> getOtherPrices() {
		return OtherPrices;
	}

	public void setOtherPrices(Optional<OtherPrices2> OtherPrices) {
