...
import com.tools20022.repository.dict.msg.RedemptionMultipleExecution5;
import com.tools20022.repository.dict.msg.CopyInformation4;
import com.tools20022.repository.dict.msg.Extension1;

/**
 * Scope The RedemptionOrderConfirmation message is sent by an executing party,
 ...
 * of execution for a previously received RedemptionOrder message. Usage The
 ...
 * instruments in each individual order may be different. When a
 * RedemptionOrderConfirmation message contains fewer confirmations that
 * originally instructed in the original RedemptionOrder message, there is no
 ...
 * RedemptionOrder message in which the individual order was conveyed may also
 * be quoted in RelatedReference but this is not recommended. A RedemptionOrder
 * must in all cases be responded to by a RedemptionOrderConfirmation message
 * and in no circumstances by a RedemptionBulkOrderConfirmation message. If the
 * executing party needs to confirm one or more redemption orders for the same
 * financial instrument then a RedemptionBulkOrderConfirmation message must be
...
public class RedemptionOrderConfirmationV04
	...
	private RedemptionMultipleExecution5 MultipleExecutionDetails;
	...
	public void setMultipleExecutionDetails(
			RedemptionMultipleExecution5 MultipleExecutionDetails) {
