...
import com.tools20022.repository.dict.choice.UnableToApplyJustification3Choice;
 ...
 */
@PreviousVersion(UnableToApplyV04.class)
public class UnableToApplyV05 implements GeneratedRepoBean<MMMessageDefinition> {

	private CaseAssignment3 Assignment;
	private Case3 Case;
	private UnderlyingTransaction3Choice Underlying;
	private UnableToApplyJustification3Choice Justification;
