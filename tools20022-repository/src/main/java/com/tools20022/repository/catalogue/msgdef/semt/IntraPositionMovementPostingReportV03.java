...
import com.tools20022.repository.dict.msg.FinancialInstrumentDetails10;
 ...
 */
@PreviousVersion(IntraPositionMovementPostingReportV02.class)
@NextVersion(IntraPositionMovementPostingReportV04.class)
public class IntraPositionMovementPostingReportV03 {
	...
	private Optional<FinancialInstrumentDetails10> FinancialInstrument;
	...
	public Optional<FinancialInstrumentDetails10> getFinancialInstrument() {
		return FinancialInstrument;
	}

	public void setFinancialInstrument(
			Optional<FinancialInstrumentDetails10> FinancialInstrument) {
