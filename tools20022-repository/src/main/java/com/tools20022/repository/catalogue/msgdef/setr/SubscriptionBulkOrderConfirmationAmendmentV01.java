 ...
 * a previously sent SubscriptionBulkOrderConfirmation message. Usage The
 * SubscriptionBulkOrderConfirmationAmendment message is used to amend one or
 * more previously sent subscription bulk order confirmations. Each bulk order
