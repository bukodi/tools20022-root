...
import com.tools20022.repository.dict.msg.Transfer19;
import com.tools20022.repository.dict.msg.InvestmentAccount22;
import com.tools20022.repository.dict.msg.ReceiveInformation9;
 ...
 */
@PreviousVersion(TransferOutInstructionV03.class)
@NextVersion(TransferOutInstructionV05.class)
public class TransferOutInstructionV04 {
	...
	private Transfer19 TransferDetails;
	private InvestmentAccount22 AccountDetails;
	private Optional<ReceiveInformation9> SettlementDetails;
	...
	public Transfer19 getTransferDetails() {
		return TransferDetails;
	}

	public void setTransferDetails(Transfer19 TransferDetails) {
	...
	public void setSettlementDetails(
			Optional<ReceiveInformation9> SettlementDetails) {
