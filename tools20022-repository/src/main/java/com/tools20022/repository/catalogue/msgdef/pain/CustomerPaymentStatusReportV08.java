...
import com.tools20022.repository.dict.msg.OriginalPaymentInstruction23;
 ...
 * scenarios. The CustomerPaymentStatusReport may also be sent to the receiver
 * of the payment in a real time payment scenario, as both sides of the
...
public class CustomerPaymentStatusReportV08 {
	...
	private Optional<OriginalPaymentInstruction23> OriginalPaymentInformationAndStatus;
	...
	public void setOriginalGroupInformationAndStatus(
			OriginalGroupHeader7 OriginalGroupInformationAndStatus) {
		this.OriginalGroupInformationAndStatus = OriginalGroupInformationAndStatus;
	}

	public Optional<OriginalPaymentInstruction23> getOriginalPaymentInformationAndStatus() {
		return OriginalPaymentInformationAndStatus;
	}

	public void setOriginalPaymentInformationAndStatus(
			Optional<OriginalPaymentInstruction23> OriginalPaymentInformationAndStatus) {
