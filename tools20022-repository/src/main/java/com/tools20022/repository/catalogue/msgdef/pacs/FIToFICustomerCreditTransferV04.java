...
import com.tools20022.repository.dict.msg.CreditTransferTransaction7;
 ...
 * scenarios.
 */
@PreviousVersion(FIToFICustomerCreditTransferV03.class)
@NextVersion(FIToFICustomerCreditTransferV05.class)
public class FIToFICustomerCreditTransferV04
		implements
			GeneratedRepoBean<MMMessageDefinition> {

	private GroupHeader49 GroupHeader;
	private CreditTransferTransaction7 CreditTransferTransactionInformation;
	...
	public CreditTransferTransaction7 getCreditTransferTransactionInformation() {
		return CreditTransferTransactionInformation;
	}

	public void setCreditTransferTransactionInformation(
			CreditTransferTransaction7 CreditTransferTransactionInformation) {
