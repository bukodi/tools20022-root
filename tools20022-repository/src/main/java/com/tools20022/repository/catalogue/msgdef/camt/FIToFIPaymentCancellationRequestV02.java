...
import com.tools20022.repository.dict.msg.UnderlyingTransaction5;
 ...
 */
@PreviousVersion(FIToFIPaymentCancellationRequestV01.class)
@NextVersion(FIToFIPaymentCancellationRequestV03.class)
public class FIToFIPaymentCancellationRequestV02
	...
	private UnderlyingTransaction5 Underlying;
	...
	public UnderlyingTransaction5 getUnderlying() {
		return Underlying;
	}

	public void setUnderlying(UnderlyingTransaction5 Underlying) {
