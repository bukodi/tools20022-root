...
import com.tools20022.repository.dict.msg.MandateCancellation5;
 ...
 */
@PreviousVersion(MandateCancellationRequestV04.class)
public class MandateCancellationRequestV05 {

	private GroupHeader47 GroupHeader;
	private MandateCancellation5 UnderlyingCancellationDetails;
	...
	public MandateCancellation5 getUnderlyingCancellationDetails() {
		return UnderlyingCancellationDetails;
	}

	public void setUnderlyingCancellationDetails(
			MandateCancellation5 UnderlyingCancellationDetails) {
