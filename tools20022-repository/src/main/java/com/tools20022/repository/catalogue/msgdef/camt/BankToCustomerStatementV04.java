 ...
 */
@PreviousVersion(BankToCustomerStatementV03.class)
@NextVersion(BankToCustomerStatementV05.class)
public class BankToCustomerStatementV04 {

	private GroupHeader58 GroupHeader;
	private AccountStatement4 Statement;
	...
	public AccountStatement4 getStatement() {
		return Statement;
	}

	public void setStatement(AccountStatement4 Statement) {
