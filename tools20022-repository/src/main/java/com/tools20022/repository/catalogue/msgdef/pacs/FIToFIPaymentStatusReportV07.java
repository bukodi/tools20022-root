...
import com.tools20022.repository.catalogue.msgdef.pacs.FIToFIPaymentStatusReportV08;
...
import com.tools20022.repository.dict.msg.PaymentTransaction63;
 ...
 */
@PreviousVersion(FIToFIPaymentStatusReportV06.class)
@NextVersion(FIToFIPaymentStatusReportV08.class)
public class FIToFIPaymentStatusReportV07
	...
	private Optional<PaymentTransaction63> TransactionInformationAndStatus;
	...
	public Optional<PaymentTransaction63> getTransactionInformationAndStatus() {
		return TransactionInformationAndStatus;
	}

	public void setTransactionInformationAndStatus(
			Optional<PaymentTransaction63> TransactionInformationAndStatus) {
