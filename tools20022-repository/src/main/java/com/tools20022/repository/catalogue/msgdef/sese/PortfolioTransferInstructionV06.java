...
import com.tools20022.repository.catalogue.msgdef.sese.PortfolioTransferInstructionV07;
...
import com.tools20022.repository.dict.msg.ISATransfer18;
 ...
 * message.
 */
@PreviousVersion(PortfolioTransferInstructionV05.class)
@NextVersion(PortfolioTransferInstructionV07.class)
public class PortfolioTransferInstructionV06
	...
	private ISATransfer18 ProductTransfer;
	...
	public ISATransfer18 getProductTransfer() {
		return ProductTransfer;
	}

	public void setProductTransfer(ISATransfer18 ProductTransfer) {
