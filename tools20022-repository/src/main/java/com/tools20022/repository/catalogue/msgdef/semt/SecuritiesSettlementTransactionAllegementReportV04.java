...
import com.tools20022.repository.dict.msg.SecuritiesTradeDetails35;
 ...
 */
@PreviousVersion(SecuritiesSettlementTransactionAllegementReportV03.class)
@NextVersion(SecuritiesSettlementTransactionAllegementReportV05.class)
public class SecuritiesSettlementTransactionAllegementReportV04
	...
	private Optional<SecuritiesTradeDetails35> AllegementDetails;
	...
	public Optional<SecuritiesTradeDetails35> getAllegementDetails() {
		return AllegementDetails;
	}

	public void setAllegementDetails(
			Optional<SecuritiesTradeDetails35> AllegementDetails) {
