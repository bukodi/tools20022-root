...
import com.tools20022.repository.dict.msg.SubAccountIdentification17;
 ...
 * “CoexistenceXxxxRule”.
 */
@PreviousVersion(SecuritiesBalanceCustodyReportV03.class)
@NextVersion(SecuritiesBalanceCustodyReportV05.class)
public class SecuritiesBalanceCustodyReportV04 {
	...
	private Optional<AggregateBalanceInformation12> BalanceForAccount;
	private Optional<SubAccountIdentification17> SubAccountDetails;
	...
	public Optional<AggregateBalanceInformation12> getBalanceForAccount() {
		return BalanceForAccount;
	}

	public void setBalanceForAccount(
			Optional<AggregateBalanceInformation12> BalanceForAccount) {
		this.BalanceForAccount = BalanceForAccount;
	}

	public Optional<SubAccountIdentification17> getSubAccountDetails() {
		return SubAccountDetails;
	}

	public void setSubAccountDetails(
			Optional<SubAccountIdentification17> SubAccountDetails) {
