...
import com.tools20022.repository.dict.msg.FinancialInstrumentDetails9;
import com.tools20022.repository.dict.msg.SubAccountIdentification21;
 ...
 * “CoexistenceXxxxRule”.
 */
@PreviousVersion(SecuritiesTransactionPostingReportV02.class)
@NextVersion(SecuritiesTransactionPostingReportV04.class)
public class SecuritiesTransactionPostingReportV03 {
	...
	private Optional<FinancialInstrumentDetails9> FinancialInstrumentDetails;
	private Optional<SubAccountIdentification21> SubAccountDetails;
	...
	public Optional<FinancialInstrumentDetails9> getFinancialInstrumentDetails() {
		return FinancialInstrumentDetails;
	}

	public void setFinancialInstrumentDetails(
			Optional<FinancialInstrumentDetails9> FinancialInstrumentDetails) {
		this.FinancialInstrumentDetails = FinancialInstrumentDetails;
	}

	public Optional<SubAccountIdentification21> getSubAccountDetails() {
		return SubAccountDetails;
	}

	public void setSubAccountDetails(
			Optional<SubAccountIdentification21> SubAccountDetails) {
