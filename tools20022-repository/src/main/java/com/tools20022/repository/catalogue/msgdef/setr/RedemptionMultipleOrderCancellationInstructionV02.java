...
import com.tools20022.repository.dict.msg.RedemptionMultipleOrderInstruction1;

/**
 * Scope The RedemptionMultipleOrderCancellationInstruction message is sent by
 ...
 * RedemptionMultipleOrder instruction. Usage The
 * RedemptionMultipleOrderCancellationInstruction message is used to cancel the
 * entire previously sent RedemptionMultipleOrder message and all the individual
 ...
 */
@NextVersion(RedemptionOrderCancellationRequestV03.class)
public class RedemptionMultipleOrderCancellationInstructionV02 {
	...
	private Optional<RedemptionMultipleOrderInstruction1> OrderToBeCancelled;
	...
	public void setOrderToBeCancelled(
			Optional<RedemptionMultipleOrderInstruction1> OrderToBeCancelled) {
