...
/**
 * Scope The SubscriptionOrderCancellationRequest message is sent by an
 ...
 * request the cancellation of a previously sent SubscriptionOrder. Usage The
 ...
 * in the original SubscriptionOrder message is specified in the order reference
 * element. The message identification of the SubscriptionOrder message which
 ...
 * SubscriptionOrderCancellationRequest is made using an
 * OrderCancellationStatusReport message.
 */
@PreviousVersion(SubscriptionOrderCancellationRequestV03.class)
