...
import com.tools20022.repository.catalogue.msgdef.pain.MandateCancellationRequestV05;
import com.tools20022.core.repo.NextVersion;
import com.tools20022.repository.dict.msg.GroupHeader47;
import com.tools20022.repository.dict.msg.MandateCancellation4;
 ...
 */
@PreviousVersion(MandateCancellationRequestV03.class)
@NextVersion(MandateCancellationRequestV05.class)
public class MandateCancellationRequestV04
		implements
			GeneratedRepoBean<MMMessageDefinition> {

	private GroupHeader47 GroupHeader;
	private MandateCancellation4 UnderlyingCancellationDetails;
	...
	public MandateCancellation4 getUnderlyingCancellationDetails() {
		return UnderlyingCancellationDetails;
	}

	public void setUnderlyingCancellationDetails(
			MandateCancellation4 UnderlyingCancellationDetails) {
