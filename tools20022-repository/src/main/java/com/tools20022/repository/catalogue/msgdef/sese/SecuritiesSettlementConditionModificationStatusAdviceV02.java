...
import com.tools20022.repository.catalogue.msgdef.sese.SecuritiesSettlementConditionModificationStatusAdviceV01;
...
import com.tools20022.repository.dict.choice.ProcessingStatus14Choice;
 ...
 * investment management institution or a broker/dealer. Usage A
 * SecuritiesSettlementConditionsModificationRequest may contain requests on
 ...
 * in the Business Application Header. ISO 15022 - 20022 Coexistence This ISO
 * 20022 message is reversed engineered from ISO 15022. Both standards will
 ...
 */
@PreviousVersion(SecuritiesSettlementConditionModificationStatusAdviceV01.class)
@NextVersion(SecuritiesSettlementConditionModificationStatusAdviceV03.class)
public class SecuritiesSettlementConditionModificationStatusAdviceV02 {
	...
	private Optional<RequestDetails6> RequestDetails;
	private ProcessingStatus14Choice ProcessingStatus;
	...
	public void setRequestDetails(Optional<RequestDetails6> RequestDetails) {
		this.RequestDetails = RequestDetails;
	}

	public ProcessingStatus14Choice getProcessingStatus() {
		return ProcessingStatus;
	}

	public void setProcessingStatus(ProcessingStatus14Choice ProcessingStatus) {
