...
import com.tools20022.repository.dict.msg.UnderlyingTransaction16;
 ...
 * has been fully processed already by the instructed agent - or assignee).
 * 
 ...
 * assignee(s). For the FIToFIPaymentCancellationRequest message the case has
 * been made optional, as the message might be used outside of a case management
 ...
 */
@PreviousVersion(FIToFIPaymentCancellationRequestV05.class)
public class FIToFIPaymentCancellationRequestV06 {
	...
	private UnderlyingTransaction16 Underlying;
	...
	public UnderlyingTransaction16 getUnderlying() {
		return Underlying;
	}

	public void setUnderlying(UnderlyingTransaction16 Underlying) {
