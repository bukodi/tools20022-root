...
import com.tools20022.repository.dict.msg.MandateAcceptance5;
 ...
 * scenarios.
 */
@PreviousVersion(MandateAcceptanceReportV04.class)
public class MandateAcceptanceReportV05
		implements
			GeneratedRepoBean<MMMessageDefinition> {

	private GroupHeader47 GroupHeader;
	private MandateAcceptance5 UnderlyingAcceptanceDetails;
	...
	public MandateAcceptance5 getUnderlyingAcceptanceDetails() {
		return UnderlyingAcceptanceDetails;
	}

	public void setUnderlyingAcceptanceDetails(
			MandateAcceptance5 UnderlyingAcceptanceDetails) {
