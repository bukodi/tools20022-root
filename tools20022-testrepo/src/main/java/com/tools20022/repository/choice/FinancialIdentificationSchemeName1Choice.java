...
public class FinancialIdentificationSchemeName1Choice {
	...
	public static final MMMessageAttribute<FinancialIdentificationSchemeName1Choice, ExternalFinancialInstitutionIdentification1Code> mmCode = new MMMessageAttribute<FinancialIdentificationSchemeName1Choice, ExternalFinancialInstitutionIdentification1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.FinancialIdentificationSchemeName1Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalFinancialInstitutionIdentification1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.FinancialIdentificationSchemeName1Choice.mmCode,
						com.tools20022.repository.choice.FinancialIdentificationSchemeName1Choice.mmProprietary));
