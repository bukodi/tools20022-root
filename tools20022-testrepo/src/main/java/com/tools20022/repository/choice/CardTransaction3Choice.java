...
import com.tools20022.repository.msgpart.CardIndividualTransaction2;
...
public class CardTransaction3Choice {
	...
	public static final MMMessageAssociationEnd<CardTransaction3Choice, CardAggregated2> mmAggregated = new MMMessageAssociationEnd<CardTransaction3Choice, CardAggregated2>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.CardTransaction3Choice.mmObject());
			isDerived = false;
			xmlTag = "Aggtd";
	...
	public static final MMMessageAssociationEnd<CardTransaction3Choice, CardIndividualTransaction2> mmIndividual = new MMMessageAssociationEnd<CardTransaction3Choice, CardIndividualTransaction2>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = LazyReference.create(() -> CardIndividualTransaction2.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.CardTransaction3Choice.mmAggregated, com.tools20022.repository.choice.CardTransaction3Choice.mmIndividual));
