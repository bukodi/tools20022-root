...
public class ReturnReason5Choice {
	...
	public static final MMMessageAttribute<ReturnReason5Choice, ExternalReturnReason1Code> mmCode = new MMMessageAttribute<ReturnReason5Choice, ExternalReturnReason1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.ReturnReason5Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalReturnReason1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.ReturnReason5Choice.mmCode, com.tools20022.repository.choice.ReturnReason5Choice.mmProprietary));
