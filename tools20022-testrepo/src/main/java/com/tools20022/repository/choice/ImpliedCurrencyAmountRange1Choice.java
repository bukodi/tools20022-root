...
import com.tools20022.repository.msgpart.FromToAmountRange1;
...
public class ImpliedCurrencyAmountRange1Choice {
	...
	public static final MMMessageAttribute<ImpliedCurrencyAmountRange1Choice, AmountRangeBoundary1> mmFromAmount = new MMMessageAttribute<ImpliedCurrencyAmountRange1Choice, AmountRangeBoundary1>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.ImpliedCurrencyAmountRange1Choice.mmObject());
			isDerived = false;
			xmlTag = "FrAmt";
	...
	public static final MMMessageAttribute<ImpliedCurrencyAmountRange1Choice, FromToAmountRange1> mmFromToAmount = new MMMessageAttribute<ImpliedCurrencyAmountRange1Choice, FromToAmountRange1>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = LazyReference.create(() -> FromToAmountRange1.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.ImpliedCurrencyAmountRange1Choice.mmFromAmount, com.tools20022.repository.choice.ImpliedCurrencyAmountRange1Choice.mmToAmount,
