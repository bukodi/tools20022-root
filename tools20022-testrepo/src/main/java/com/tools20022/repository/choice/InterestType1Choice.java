...
public class InterestType1Choice {
	...
	public static final MMMessageAttribute<InterestType1Choice, InterestType1Code> mmCode = new MMMessageAttribute<InterestType1Choice, InterestType1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.InterestType1Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> InterestType1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.InterestType1Choice.mmCode, com.tools20022.repository.choice.InterestType1Choice.mmProprietary));
