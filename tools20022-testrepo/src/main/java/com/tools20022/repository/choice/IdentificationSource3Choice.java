...
public class IdentificationSource3Choice {
	...
	public static final MMMessageAttribute<IdentificationSource3Choice, ExternalFinancialInstrumentIdentificationType1Code> mmCode = new MMMessageAttribute<IdentificationSource3Choice, ExternalFinancialInstrumentIdentificationType1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.IdentificationSource3Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalFinancialInstrumentIdentificationType1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.IdentificationSource3Choice.mmCode, com.tools20022.repository.choice.IdentificationSource3Choice.mmProprietary));
