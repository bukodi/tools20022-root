...
public class ReportingSource1Choice {
	...
	public static final MMMessageAttribute<ReportingSource1Choice, ExternalReportingSource1Code> mmCode = new MMMessageAttribute<ReportingSource1Choice, ExternalReportingSource1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.ReportingSource1Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalReportingSource1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.ReportingSource1Choice.mmCode, com.tools20022.repository.choice.ReportingSource1Choice.mmProprietary));
