...
public class CashAccountType2Choice {
	...
	public static final MMMessageAttribute<CashAccountType2Choice, ExternalCashAccountType1Code> mmCode = new MMMessageAttribute<CashAccountType2Choice, ExternalCashAccountType1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.CashAccountType2Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalCashAccountType1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.CashAccountType2Choice.mmCode, com.tools20022.repository.choice.CashAccountType2Choice.mmProprietary));
