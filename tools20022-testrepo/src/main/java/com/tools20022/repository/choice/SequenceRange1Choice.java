...
import com.tools20022.repository.msgpart.SequenceRange1;
...
public class SequenceRange1Choice {
	...
	public static final MMMessageAttribute<SequenceRange1Choice, Max35Text> mmFromSequence = new MMMessageAttribute<SequenceRange1Choice, Max35Text>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.SequenceRange1Choice.mmObject());
			isDerived = false;
			xmlTag = "FrSeq";
	 ...
	 * type} = {@linkplain com.tools20022.repository.msgpart.SequenceRange1
	 * SequenceRange1}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAssociationEnd<SequenceRange1Choice, List<SequenceRange1>> mmFromToSequence = new MMMessageAssociationEnd<SequenceRange1Choice, List<SequenceRange1>>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = LazyReference.create(() -> SequenceRange1.mmObject());
		}
