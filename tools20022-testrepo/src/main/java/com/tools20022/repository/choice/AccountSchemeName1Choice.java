...
public class AccountSchemeName1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.AccountSchemeName1Choice.mmCode, com.tools20022.repository.choice.AccountSchemeName1Choice.mmProprietary));
