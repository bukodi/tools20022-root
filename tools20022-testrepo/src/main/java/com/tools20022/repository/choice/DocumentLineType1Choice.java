...
public class DocumentLineType1Choice {
	...
	public static final MMMessageAttribute<DocumentLineType1Choice, ExternalDocumentLineType1Code> mmCode = new MMMessageAttribute<DocumentLineType1Choice, ExternalDocumentLineType1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.DocumentLineType1Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalDocumentLineType1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.DocumentLineType1Choice.mmCode, com.tools20022.repository.choice.DocumentLineType1Choice.mmProprietary));
