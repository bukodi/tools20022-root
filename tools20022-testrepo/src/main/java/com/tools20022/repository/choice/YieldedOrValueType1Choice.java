...
public class YieldedOrValueType1Choice {
	...
	public static final MMMessageAttribute<YieldedOrValueType1Choice, YesNoIndicator> mmYielded = new MMMessageAttribute<YieldedOrValueType1Choice, YesNoIndicator>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.YieldedOrValueType1Choice.mmObject());
			isDerived = false;
			xmlTag = "Yldd";
	...
	public static final MMMessageAttribute<YieldedOrValueType1Choice, PriceValueType1Code> mmValueType = new MMMessageAttribute<YieldedOrValueType1Choice, PriceValueType1Code>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> PriceValueType1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.YieldedOrValueType1Choice.mmYielded, com.tools20022.repository.choice.YieldedOrValueType1Choice.mmValueType));
