...
public class ReferredDocumentType3Choice {
	...
	public static final MMMessageAttribute<ReferredDocumentType3Choice, DocumentType6Code> mmCode = new MMMessageAttribute<ReferredDocumentType3Choice, DocumentType6Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.ReferredDocumentType3Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> DocumentType6Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.ReferredDocumentType3Choice.mmCode, com.tools20022.repository.choice.ReferredDocumentType3Choice.mmProprietary));
