...
public class TechnicalInputChannel1Choice {
	...
	public static final MMMessageAttribute<TechnicalInputChannel1Choice, ExternalTechnicalInputChannel1Code> mmCode = new MMMessageAttribute<TechnicalInputChannel1Choice, ExternalTechnicalInputChannel1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.TechnicalInputChannel1Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalTechnicalInputChannel1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.TechnicalInputChannel1Choice.mmCode, com.tools20022.repository.choice.TechnicalInputChannel1Choice.mmProprietary));
