...
public class EntryStatus1Choice {
	...
	public static final MMMessageAttribute<EntryStatus1Choice, ExternalEntryStatus1Code> mmCode = new MMMessageAttribute<EntryStatus1Choice, ExternalEntryStatus1Code>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.choice.EntryStatus1Choice.mmObject());
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> ExternalEntryStatus1Code.mmObject());
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.choice.EntryStatus1Choice.mmCode, com.tools20022.repository.choice.EntryStatus1Choice.mmProprietary));
