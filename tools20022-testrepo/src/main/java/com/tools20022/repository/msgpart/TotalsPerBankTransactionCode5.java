...
import com.tools20022.repository.msgpart.NumberAndSumOfTransactions1;
import java.util.*;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmNumberOfEntries
 * TotalsPerBankTransactionCode5.mmNumberOfEntries}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmSum
 * TotalsPerBankTransactionCode5.mmSum}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmTotalNetEntry
 * TotalsPerBankTransactionCode5.mmTotalNetEntry}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmCreditEntries
 * TotalsPerBankTransactionCode5.mmCreditEntries}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmDebitEntries
 * TotalsPerBankTransactionCode5.mmDebitEntries}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmForecastIndicator
 * TotalsPerBankTransactionCode5.mmForecastIndicator}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmBankTransactionCode
 * TotalsPerBankTransactionCode5.mmBankTransactionCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmAvailability
 * TotalsPerBankTransactionCode5.mmAvailability}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5#mmDate
...
public class TotalsPerBankTransactionCode5 {
	...
	public static final MMMessageAttribute<TotalsPerBankTransactionCode5, Optional<Max15NumericText>> mmNumberOfEntries = new MMMessageAttribute<TotalsPerBankTransactionCode5, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmObject());
			isDerived = false;
			xmlTag = "NbOfNtries";
	...
	public static final MMMessageAttribute<TotalsPerBankTransactionCode5, Optional<NumberAndSumOfTransactions1>> mmCreditEntries = new MMMessageAttribute<TotalsPerBankTransactionCode5, Optional<NumberAndSumOfTransactions1>>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = LazyReference.create(() -> NumberAndSumOfTransactions1.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmNumberOfEntries, com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmSum,
						com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmTotalNetEntry, com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmCreditEntries,
						com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmDebitEntries, com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmForecastIndicator,
						com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmBankTransactionCode, com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmAvailability,
						com.tools20022.repository.msgpart.TotalsPerBankTransactionCode5.mmDate));
	...
	public Optional<NumberAndSumOfTransactions1> getCreditEntries() {
		return Optional.ofNullable(creditEntries);
	}
	...
	public Optional<NumberAndSumOfTransactions1> getDebitEntries() {
		return Optional.ofNullable(debitEntries);
	}
	...
	public Optional<TrueFalseIndicator> getForecastIndicator() {
		return Optional.ofNullable(forecastIndicator);
	}
