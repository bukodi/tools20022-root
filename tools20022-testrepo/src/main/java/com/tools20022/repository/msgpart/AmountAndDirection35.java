 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AmountAndDirection35#mmAmount
 * AmountAndDirection35.mmAmount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AmountAndDirection35#mmCreditDebitIndicator
...
public class AmountAndDirection35 {
	...
	public static final MMMessageAttribute<AmountAndDirection35, NonNegativeDecimalNumber> mmAmount = new MMMessageAttribute<AmountAndDirection35, NonNegativeDecimalNumber>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.AmountAndDirection35.mmObject());
			isDerived = false;
			xmlTag = "Amt";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> NonNegativeDecimalNumber.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.AmountAndDirection35.mmAmount, com.tools20022.repository.msgpart.AmountAndDirection35.mmCreditDebitIndicator));
