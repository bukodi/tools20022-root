 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.BalanceType13#mmCodeOrProprietary
 * BalanceType13.mmCodeOrProprietary}</li>
 * <li>{@linkplain com.tools20022.repository.msgpart.BalanceType13#mmSubType
...
public class BalanceType13 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.BalanceType13
	 * BalanceType13}</li>
	...
	public static final MMMessageAssociationEnd<BalanceType13, BalanceType10Choice> mmCodeOrProprietary = new MMMessageAssociationEnd<BalanceType13, BalanceType10Choice>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.BalanceType13.mmObject());
			isDerived = false;
			xmlTag = "CdOrPrtry";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = LazyReference.create(() -> BalanceType10Choice.mmObject());
		}
	...
	public static final MMMessageAssociationEnd<BalanceType13, Optional<BalanceSubType1Choice>> mmSubType = new MMMessageAssociationEnd<BalanceType13, Optional<BalanceSubType1Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> BalanceSubType1Choice.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.BalanceType13.mmCodeOrProprietary, com.tools20022.repository.msgpart.BalanceType13.mmSubType));
