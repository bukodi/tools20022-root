 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.ReferredDocumentType2#mmCodeOrProprietary
 * ReferredDocumentType2.mmCodeOrProprietary}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.ReferredDocumentType2#mmIssuer
...
public class ReferredDocumentType2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.ReferredDocumentType2
	 * ReferredDocumentType2}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.ReferredDocumentType2.mmCodeOrProprietary, com.tools20022.repository.msgpart.ReferredDocumentType2.mmIssuer));
