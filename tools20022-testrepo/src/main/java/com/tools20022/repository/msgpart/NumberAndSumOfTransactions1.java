 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.NumberAndSumOfTransactions1#mmNumberOfEntries
 * NumberAndSumOfTransactions1.mmNumberOfEntries}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.NumberAndSumOfTransactions1#mmSum
...
public class NumberAndSumOfTransactions1 {
	...
	public static final MMMessageAttribute<NumberAndSumOfTransactions1, Optional<Max15NumericText>> mmNumberOfEntries = new MMMessageAttribute<NumberAndSumOfTransactions1, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.NumberAndSumOfTransactions1.mmObject());
			isDerived = false;
			xmlTag = "NbOfNtries";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.NumberAndSumOfTransactions1.mmNumberOfEntries, com.tools20022.repository.msgpart.NumberAndSumOfTransactions1.mmSum));
