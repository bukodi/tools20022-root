 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CreditorReferenceType2#mmCodeOrProprietary
 * CreditorReferenceType2.mmCodeOrProprietary}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CreditorReferenceType2#mmIssuer
...
public class CreditorReferenceType2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.CreditorReferenceType2
	 * CreditorReferenceType2}</li>
	...
	public static final MMMessageAssociationEnd<CreditorReferenceType2, CreditorReferenceType1Choice> mmCodeOrProprietary = new MMMessageAssociationEnd<CreditorReferenceType2, CreditorReferenceType1Choice>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.CreditorReferenceType2.mmObject());
			isDerived = false;
			xmlTag = "CdOrPrtry";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = LazyReference.create(() -> CreditorReferenceType1Choice.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.CreditorReferenceType2.mmCodeOrProprietary, com.tools20022.repository.msgpart.CreditorReferenceType2.mmIssuer));
