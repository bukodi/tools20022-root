 ...
 * messageElements} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msgpart.CreditLine3#mmIncluded
 * CreditLine3.mmIncluded}</li>
 * <li>{@linkplain com.tools20022.repository.msgpart.CreditLine3#mmType
 * CreditLine3.mmType}</li>
 * <li>{@linkplain com.tools20022.repository.msgpart.CreditLine3#mmAmount
 * CreditLine3.mmAmount}</li>
 * <li>{@linkplain com.tools20022.repository.msgpart.CreditLine3#mmDate
...
public class CreditLine3 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.CreditLine3 CreditLine3}</li>
	...
	public static final MMMessageAttribute<CreditLine3, TrueFalseIndicator> mmIncluded = new MMMessageAttribute<CreditLine3, TrueFalseIndicator>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.CreditLine3.mmObject());
			isDerived = false;
			xmlTag = "Incl";
	...
	public static final MMMessageAssociationEnd<CreditLine3, Optional<CreditLineType1Choice>> mmType = new MMMessageAssociationEnd<CreditLine3, Optional<CreditLineType1Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> CreditLineType1Choice.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.CreditLine3.mmIncluded, com.tools20022.repository.msgpart.CreditLine3.mmType,
						com.tools20022.repository.msgpart.CreditLine3.mmAmount, com.tools20022.repository.msgpart.CreditLine3.mmDate));
