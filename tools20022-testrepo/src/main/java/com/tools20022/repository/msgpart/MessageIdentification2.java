 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.MessageIdentification2#mmMessageNameIdentification
 * MessageIdentification2.mmMessageNameIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.MessageIdentification2#mmMessageIdentification
...
public class MessageIdentification2 {
	...
	public static final MMMessageAttribute<MessageIdentification2, Optional<Max35Text>> mmMessageNameIdentification = new MMMessageAttribute<MessageIdentification2, Optional<Max35Text>>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.MessageIdentification2.mmObject());
			isDerived = false;
			xmlTag = "MsgNmId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.MessageIdentification2.mmMessageNameIdentification,
						com.tools20022.repository.msgpart.MessageIdentification2.mmMessageIdentification));
