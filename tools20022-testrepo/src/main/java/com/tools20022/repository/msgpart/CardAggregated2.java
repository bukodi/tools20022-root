...
import com.tools20022.repository.msgpart.CardSequenceNumberRange1;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CardAggregated2#mmAdditionalService
 * CardAggregated2.mmAdditionalService}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CardAggregated2#mmTransactionCategory
 * CardAggregated2.mmTransactionCategory}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CardAggregated2#mmSaleReconciliationIdentification
 * CardAggregated2.mmSaleReconciliationIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CardAggregated2#mmSequenceNumberRange
 * CardAggregated2.mmSequenceNumberRange}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CardAggregated2#mmTransactionDateRange
...
public class CardAggregated2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.CardAggregated2
	 * CardAggregated2}</li>
	...
	public static final MMMessageAttribute<CardAggregated2, Optional<CardPaymentServiceType2Code>> mmAdditionalService = new MMMessageAttribute<CardAggregated2, Optional<CardPaymentServiceType2Code>>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.CardAggregated2.mmObject());
			isDerived = false;
			xmlTag = "AddtlSvc";
	...
	public static final MMMessageAssociationEnd<CardAggregated2, Optional<CardSequenceNumberRange1>> mmSequenceNumberRange = new MMMessageAssociationEnd<CardAggregated2, Optional<CardSequenceNumberRange1>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> CardSequenceNumberRange1.mmObject());
		}
	...
	public static final MMMessageAssociationEnd<CardAggregated2, Optional<DateOrDateTimePeriod1Choice>> mmTransactionDateRange = new MMMessageAssociationEnd<CardAggregated2, Optional<DateOrDateTimePeriod1Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> DateOrDateTimePeriod1Choice.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.CardAggregated2.mmAdditionalService, com.tools20022.repository.msgpart.CardAggregated2.mmTransactionCategory,
						com.tools20022.repository.msgpart.CardAggregated2.mmSaleReconciliationIdentification, com.tools20022.repository.msgpart.CardAggregated2.mmSequenceNumberRange,
						com.tools20022.repository.msgpart.CardAggregated2.mmTransactionDateRange));
	...
	public Optional<CardSequenceNumberRange1> getSequenceNumberRange() {
		return Optional.ofNullable(sequenceNumberRange);
	}
	...
	public Optional<DateOrDateTimePeriod1Choice> getTransactionDateRange() {
		return Optional.ofNullable(transactionDateRange);
	}
