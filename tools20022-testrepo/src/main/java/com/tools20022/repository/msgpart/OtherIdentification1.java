 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OtherIdentification1#mmIdentification
 * OtherIdentification1.mmIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OtherIdentification1#mmSuffix
 * OtherIdentification1.mmSuffix}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OtherIdentification1#mmType
...
public class OtherIdentification1 {
	...
	public static final MMMessageAttribute<OtherIdentification1, Max35Text> mmIdentification = new MMMessageAttribute<OtherIdentification1, Max35Text>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.OtherIdentification1.mmObject());
			isDerived = false;
			xmlTag = "Id";
	...
	public static final MMMessageAssociationEnd<OtherIdentification1, IdentificationSource3Choice> mmType = new MMMessageAssociationEnd<OtherIdentification1, IdentificationSource3Choice>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = LazyReference.create(() -> IdentificationSource3Choice.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.OtherIdentification1.mmIdentification, com.tools20022.repository.msgpart.OtherIdentification1.mmSuffix,
						com.tools20022.repository.msgpart.OtherIdentification1.mmType));
