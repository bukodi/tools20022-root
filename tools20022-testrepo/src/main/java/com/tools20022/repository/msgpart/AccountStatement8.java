 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmIdentification
 * AccountStatement8.mmIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmStatementPagination
 * AccountStatement8.mmStatementPagination}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmElectronicSequenceNumber
 * AccountStatement8.mmElectronicSequenceNumber}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmReportingSequence
 * AccountStatement8.mmReportingSequence}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmLegalSequenceNumber
 * AccountStatement8.mmLegalSequenceNumber}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmCreationDateTime
 * AccountStatement8.mmCreationDateTime}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmFromToDate
 * AccountStatement8.mmFromToDate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmCopyDuplicateIndicator
 * AccountStatement8.mmCopyDuplicateIndicator}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmReportingSource
 * AccountStatement8.mmReportingSource}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmAccount
 * AccountStatement8.mmAccount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmRelatedAccount
 * AccountStatement8.mmRelatedAccount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmInterest
 * AccountStatement8.mmInterest}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmBalance
 * AccountStatement8.mmBalance}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmTransactionsSummary
 * AccountStatement8.mmTransactionsSummary}</li>
 * <li>{@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmEntry
 * AccountStatement8.mmEntry}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.AccountStatement8#mmAdditionalStatementInformation
...
public class AccountStatement8 {
	...
	public static final MMMessageAttribute<AccountStatement8, Max35Text> mmIdentification = new MMMessageAttribute<AccountStatement8, Max35Text>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.AccountStatement8.mmObject());
			isDerived = false;
			xmlTag = "Id";
	 ...
	 * complexType} = {@linkplain com.tools20022.repository.msgpart.Pagination1
	 * Pagination1}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAttribute<AccountStatement8, Optional<Pagination1>> mmStatementPagination = new MMMessageAttribute<AccountStatement8, Optional<Pagination1>>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = LazyReference.create(() -> Pagination1.mmObject());
		}
	...
	public static final MMMessageAssociationEnd<AccountStatement8, Optional<SequenceRange1Choice>> mmReportingSequence = new MMMessageAssociationEnd<AccountStatement8, Optional<SequenceRange1Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> SequenceRange1Choice.mmObject());
		}
	...
	public static final MMMessageAttribute<AccountStatement8, Optional<CopyDuplicate1Code>> mmCopyDuplicateIndicator = new MMMessageAttribute<AccountStatement8, Optional<CopyDuplicate1Code>>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = LazyReference.create(() -> CopyDuplicate1Code.mmObject());
		}
	...
	public static final MMMessageAssociationEnd<AccountStatement8, Optional<ReportingSource1Choice>> mmReportingSource = new MMMessageAssociationEnd<AccountStatement8, Optional<ReportingSource1Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> ReportingSource1Choice.mmObject());
		}
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msgpart.CashAccount36
	 * CashAccount36}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAssociationEnd<AccountStatement8, CashAccount36> mmAccount = new MMMessageAssociationEnd<AccountStatement8, CashAccount36>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = LazyReference.create(() -> CashAccount36.mmObject());
		}
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msgpart.AccountInterest4
	 * AccountInterest4}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAssociationEnd<AccountStatement8, List<AccountInterest4>> mmInterest = new MMMessageAssociationEnd<AccountStatement8, List<AccountInterest4>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> AccountInterest4.mmObject());
		}
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msgpart.CashBalance8
	 * CashBalance8}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAssociationEnd<AccountStatement8, List<CashBalance8>> mmBalance = new MMMessageAssociationEnd<AccountStatement8, List<CashBalance8>>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = LazyReference.create(() -> CashBalance8.mmObject());
		}
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msgpart.TotalTransactions6
	...
	public static final MMMessageAssociationEnd<AccountStatement8, Optional<TotalTransactions6>> mmTransactionsSummary = new MMMessageAssociationEnd<AccountStatement8, Optional<TotalTransactions6>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> TotalTransactions6.mmObject());
		}
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msgpart.ReportEntry9
	 * ReportEntry9}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAssociationEnd<AccountStatement8, List<ReportEntry9>> mmEntry = new MMMessageAssociationEnd<AccountStatement8, List<ReportEntry9>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> ReportEntry9.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.AccountStatement8.mmIdentification, com.tools20022.repository.msgpart.AccountStatement8.mmStatementPagination,
						com.tools20022.repository.msgpart.AccountStatement8.mmElectronicSequenceNumber, com.tools20022.repository.msgpart.AccountStatement8.mmReportingSequence,
						com.tools20022.repository.msgpart.AccountStatement8.mmLegalSequenceNumber, com.tools20022.repository.msgpart.AccountStatement8.mmCreationDateTime, com.tools20022.repository.msgpart.AccountStatement8.mmFromToDate,
						com.tools20022.repository.msgpart.AccountStatement8.mmCopyDuplicateIndicator, com.tools20022.repository.msgpart.AccountStatement8.mmReportingSource, com.tools20022.repository.msgpart.AccountStatement8.mmAccount,
						com.tools20022.repository.msgpart.AccountStatement8.mmRelatedAccount, com.tools20022.repository.msgpart.AccountStatement8.mmInterest, com.tools20022.repository.msgpart.AccountStatement8.mmBalance,
						com.tools20022.repository.msgpart.AccountStatement8.mmTransactionsSummary, com.tools20022.repository.msgpart.AccountStatement8.mmEntry,
						com.tools20022.repository.msgpart.AccountStatement8.mmAdditionalStatementInformation));
				messageBuildingBlocks_lazy = LazyReference.create(() -> Arrays.asList(BankToCustomerStatementV07.mmStatement));
	...
	public Optional<Pagination1> getStatementPagination() {
		return Optional.ofNullable(statementPagination);
	}
	...
	public Optional<Number> getElectronicSequenceNumber() {
		return Optional.ofNullable(electronicSequenceNumber);
	}
	...
	public Optional<SequenceRange1Choice> getReportingSequence() {
		return Optional.ofNullable(reportingSequence);
	}
	...
	public Optional<Number> getLegalSequenceNumber() {
		return Optional.ofNullable(legalSequenceNumber);
	}
	...
	public Optional<CopyDuplicate1Code> getCopyDuplicateIndicator() {
		return Optional.ofNullable(copyDuplicateIndicator);
	}
	...
	public Optional<ReportingSource1Choice> getReportingSource() {
		return Optional.ofNullable(reportingSource);
	}
	...
	public Optional<TotalTransactions6> getTransactionsSummary() {
		return Optional.ofNullable(transactionsSummary);
	}
	...
	public Optional<Max500Text> getAdditionalStatementInformation() {
		return Optional.ofNullable(additionalStatementInformation);
	}
