 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.ClearingSystemMemberIdentification2#mmClearingSystemIdentification
 * ClearingSystemMemberIdentification2.mmClearingSystemIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.ClearingSystemMemberIdentification2#mmMemberIdentification
...
public class ClearingSystemMemberIdentification2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.ClearingSystemMemberIdentification2.mmClearingSystemIdentification,
	...
	public Optional<ClearingSystemIdentification2Choice> getClearingSystemIdentification() {
		return Optional.ofNullable(clearingSystemIdentification);
	}
