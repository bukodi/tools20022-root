 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CardSequenceNumberRange1#mmFirstTransaction
 * CardSequenceNumberRange1.mmFirstTransaction}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CardSequenceNumberRange1#mmLastTransaction
...
public class CardSequenceNumberRange1 {
	...
	public static final MMMessageAttribute<CardSequenceNumberRange1, Optional<Max35Text>> mmFirstTransaction = new MMMessageAttribute<CardSequenceNumberRange1, Optional<Max35Text>>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.CardSequenceNumberRange1.mmObject());
			isDerived = false;
			xmlTag = "FrstTx";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.CardSequenceNumberRange1.mmFirstTransaction, com.tools20022.repository.msgpart.CardSequenceNumberRange1.mmLastTransaction));
