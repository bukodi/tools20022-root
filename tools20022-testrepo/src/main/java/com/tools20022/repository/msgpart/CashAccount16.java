...
public class CashAccount16 {
	...
	public static final MMMessageAssociationEnd<CashAccount16, AccountIdentification4Choice> mmIdentification = new MMMessageAssociationEnd<CashAccount16, AccountIdentification4Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msgpart.CashAccount16.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msgpart.CashAccount16.mmIdentification, com.tools20022.repository.msgpart.CashAccount16.mmType, com.tools20022.repository.msgpart.CashAccount16.mmCurrency,
						com.tools20022.repository.msgpart.CashAccount16.mmName);
