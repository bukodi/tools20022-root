 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OriginalAndCurrentQuantities1#mmFaceAmount
 * OriginalAndCurrentQuantities1.mmFaceAmount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OriginalAndCurrentQuantities1#mmAmortisedValue
...
public class OriginalAndCurrentQuantities1 {
	...
	public static final MMMessageAttribute<OriginalAndCurrentQuantities1, ImpliedCurrencyAndAmount> mmFaceAmount = new MMMessageAttribute<OriginalAndCurrentQuantities1, ImpliedCurrencyAndAmount>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.OriginalAndCurrentQuantities1.mmObject());
			isDerived = false;
			xmlTag = "FaceAmt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.OriginalAndCurrentQuantities1.mmFaceAmount, com.tools20022.repository.msgpart.OriginalAndCurrentQuantities1.mmAmortisedValue));
