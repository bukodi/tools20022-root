 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.SequenceRange1#mmFromSequence
 * SequenceRange1.mmFromSequence}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.SequenceRange1#mmToSequence
...
public class SequenceRange1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.SequenceRange1
	 * SequenceRange1}</li>
	...
	public static final MMMessageAttribute<SequenceRange1, Max35Text> mmFromSequence = new MMMessageAttribute<SequenceRange1, Max35Text>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.SequenceRange1.mmObject());
			isDerived = false;
			xmlTag = "FrSeq";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.SequenceRange1.mmFromSequence, com.tools20022.repository.msgpart.SequenceRange1.mmToSequence));
