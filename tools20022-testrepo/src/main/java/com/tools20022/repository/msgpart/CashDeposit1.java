 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CashDeposit1#mmNoteDenomination
 * CashDeposit1.mmNoteDenomination}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.CashDeposit1#mmNumberOfNotes
 * CashDeposit1.mmNumberOfNotes}</li>
 * <li>{@linkplain com.tools20022.repository.msgpart.CashDeposit1#mmAmount
...
public class CashDeposit1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.CashDeposit1 CashDeposit1}</li>
	...
	public static final MMMessageAttribute<CashDeposit1, ActiveCurrencyAndAmount> mmNoteDenomination = new MMMessageAttribute<CashDeposit1, ActiveCurrencyAndAmount>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.CashDeposit1.mmObject());
			isDerived = false;
			xmlTag = "NoteDnmtn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.CashDeposit1.mmNoteDenomination, com.tools20022.repository.msgpart.CashDeposit1.mmNumberOfNotes,
						com.tools20022.repository.msgpart.CashDeposit1.mmAmount));
