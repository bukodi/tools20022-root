 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.GenericIdentification1#mmIdentification
 * GenericIdentification1.mmIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.GenericIdentification1#mmSchemeName
 * GenericIdentification1.mmSchemeName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.GenericIdentification1#mmIssuer
...
public class GenericIdentification1 {
	...
	public static final MMMessageAttribute<GenericIdentification1, Max35Text> mmIdentification = new MMMessageAttribute<GenericIdentification1, Max35Text>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.GenericIdentification1.mmObject());
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.GenericIdentification1.mmIdentification, com.tools20022.repository.msgpart.GenericIdentification1.mmSchemeName,
						com.tools20022.repository.msgpart.GenericIdentification1.mmIssuer));
