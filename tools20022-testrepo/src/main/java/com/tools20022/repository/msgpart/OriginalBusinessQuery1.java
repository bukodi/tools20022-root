 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OriginalBusinessQuery1#mmMessageIdentification
 * OriginalBusinessQuery1.mmMessageIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OriginalBusinessQuery1#mmMessageNameIdentification
 * OriginalBusinessQuery1.mmMessageNameIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.OriginalBusinessQuery1#mmCreationDateTime
...
public class OriginalBusinessQuery1 {
	...
	public static final MMMessageAttribute<OriginalBusinessQuery1, Max35Text> mmMessageIdentification = new MMMessageAttribute<OriginalBusinessQuery1, Max35Text>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.OriginalBusinessQuery1.mmObject());
			isDerived = false;
			xmlTag = "MsgId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.OriginalBusinessQuery1.mmMessageIdentification,
						com.tools20022.repository.msgpart.OriginalBusinessQuery1.mmMessageNameIdentification, com.tools20022.repository.msgpart.OriginalBusinessQuery1.mmCreationDateTime));
	...
	public Optional<Max35Text> getMessageNameIdentification() {
		return Optional.ofNullable(messageNameIdentification);
	}
