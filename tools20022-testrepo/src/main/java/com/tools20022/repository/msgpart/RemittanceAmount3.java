...
public class RemittanceAmount3 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.RemittanceAmount3
	 * RemittanceAmount3}</li>
	...
	public static final MMMessageAttribute<RemittanceAmount3, Optional<ActiveOrHistoricCurrencyAndAmount>> mmDuePayableAmount = new MMMessageAttribute<RemittanceAmount3, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.RemittanceAmount3.mmObject());
			isDerived = false;
			xmlTag = "DuePyblAmt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DuePayableAmount";
			definition = "Amount specified is the exact amount due and payable to the creditor.";
			previousVersion_lazy = LazyReference.create(() -> RemittanceAmount2.mmDuePayableAmount);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<RemittanceAmount3, List<DiscountAmountAndType1>> mmDiscountAppliedAmount = new MMMessageAttribute<RemittanceAmount3, List<DiscountAmountAndType1>>() {
		{
			...
			previousVersion_lazy = LazyReference.create(() -> RemittanceAmount2.mmDiscountAppliedAmount);
			minOccurs = 0;
	...
	public static final MMMessageAttribute<RemittanceAmount3, Optional<ActiveOrHistoricCurrencyAndAmount>> mmCreditNoteAmount = new MMMessageAttribute<RemittanceAmount3, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = LazyReference.create(() -> RemittanceAmount2.mmCreditNoteAmount);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = LazyReference.create(() -> ActiveOrHistoricCurrencyAndAmount.mmObject());
		}
	...
	public static final MMMessageAttribute<RemittanceAmount3, List<TaxAmountAndType1>> mmTaxAmount = new MMMessageAttribute<RemittanceAmount3, List<TaxAmountAndType1>>() {
		{
			...
			previousVersion_lazy = LazyReference.create(() -> RemittanceAmount2.mmTaxAmount);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<RemittanceAmount3, List<DocumentAdjustment1>> mmAdjustmentAmountAndReason = new MMMessageAssociationEnd<RemittanceAmount3, List<DocumentAdjustment1>>() {
		{
			...
			previousVersion_lazy = LazyReference.create(() -> RemittanceAmount2.mmAdjustmentAmountAndReason);
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<RemittanceAmount3, Optional<ActiveOrHistoricCurrencyAndAmount>> mmRemittedAmount = new MMMessageAttribute<RemittanceAmount3, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = LazyReference.create(() -> RemittanceAmount2.mmRemittedAmount);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = LazyReference.create(() -> ActiveOrHistoricCurrencyAndAmount.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.RemittanceAmount3.mmDuePayableAmount, com.tools20022.repository.msgpart.RemittanceAmount3.mmDiscountAppliedAmount,
						com.tools20022.repository.msgpart.RemittanceAmount3.mmCreditNoteAmount, com.tools20022.repository.msgpart.RemittanceAmount3.mmTaxAmount,
						com.tools20022.repository.msgpart.RemittanceAmount3.mmAdjustmentAmountAndReason, com.tools20022.repository.msgpart.RemittanceAmount3.mmRemittedAmount));
				...
				previousVersion_lazy = LazyReference.create(() -> RemittanceAmount2.mmObject());
			}
		});
