...
import com.tools20022.repository.msgpart.CardSecurityInformation1;
import com.tools20022.repository.msgpart.TrackData1;
import java.util.*;
 ...
 * messageElements} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msgpart.PlainCardData1#mmPAN
 * PlainCardData1.mmPAN}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.PlainCardData1#mmCardSequenceNumber
 * PlainCardData1.mmCardSequenceNumber}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.PlainCardData1#mmEffectiveDate
 * PlainCardData1.mmEffectiveDate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.PlainCardData1#mmExpiryDate
 * PlainCardData1.mmExpiryDate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.PlainCardData1#mmServiceCode
 * PlainCardData1.mmServiceCode}</li>
 * <li>{@linkplain com.tools20022.repository.msgpart.PlainCardData1#mmTrackData
 * PlainCardData1.mmTrackData}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.PlainCardData1#mmCardSecurityCode
...
public class PlainCardData1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msgpart.PlainCardData1
	 * PlainCardData1}</li>
	...
	public static final MMMessageAttribute<PlainCardData1, Min8Max28NumericText> mmPAN = new MMMessageAttribute<PlainCardData1, Min8Max28NumericText>() {
		{
			componentContext_lazy = LazyReference.create(() -> com.tools20022.repository.msgpart.PlainCardData1.mmObject());
			isDerived = false;
			xmlTag = "PAN";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = LazyReference.create(() -> Min8Max28NumericText.mmObject());
		}
	...
	public static final MMMessageAttribute<PlainCardData1, Optional<Min2Max3NumericText>> mmCardSequenceNumber = new MMMessageAttribute<PlainCardData1, Optional<Min2Max3NumericText>>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = LazyReference.create(() -> Min2Max3NumericText.mmObject());
		}
	...
	public static final MMMessageAttribute<PlainCardData1, Optional<ISOYearMonth>> mmEffectiveDate = new MMMessageAttribute<PlainCardData1, Optional<ISOYearMonth>>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = LazyReference.create(() -> ISOYearMonth.mmObject());
		}
	 ...
	 * type} = {@linkplain com.tools20022.repository.msgpart.TrackData1
	 * TrackData1}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAssociationEnd<PlainCardData1, List<TrackData1>> mmTrackData = new MMMessageAssociationEnd<PlainCardData1, List<TrackData1>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> TrackData1.mmObject());
		}
	...
	public static final MMMessageAssociationEnd<PlainCardData1, Optional<CardSecurityInformation1>> mmCardSecurityCode = new MMMessageAssociationEnd<PlainCardData1, Optional<CardSecurityInformation1>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = LazyReference.create(() -> CardSecurityInformation1.mmObject());
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.PlainCardData1.mmPAN, com.tools20022.repository.msgpart.PlainCardData1.mmCardSequenceNumber,
						com.tools20022.repository.msgpart.PlainCardData1.mmEffectiveDate, com.tools20022.repository.msgpart.PlainCardData1.mmExpiryDate, com.tools20022.repository.msgpart.PlainCardData1.mmServiceCode,
						com.tools20022.repository.msgpart.PlainCardData1.mmTrackData, com.tools20022.repository.msgpart.PlainCardData1.mmCardSecurityCode));
	...
	public Optional<Min2Max3NumericText> getCardSequenceNumber() {
		return Optional.ofNullable(cardSequenceNumber);
	}
	...
	public Optional<CardSecurityInformation1> getCardSecurityCode() {
		return Optional.ofNullable(cardSecurityCode);
	}
