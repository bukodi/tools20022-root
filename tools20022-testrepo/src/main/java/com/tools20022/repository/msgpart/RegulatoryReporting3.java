...
import com.tools20022.repository.msgpart.RegulatoryAuthority2;
import com.tools20022.repository.msgpart.StructuredRegulatoryReporting3;
import java.util.*;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.RegulatoryReporting3#mmDebitCreditReportingIndicator
 * RegulatoryReporting3.mmDebitCreditReportingIndicator}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.RegulatoryReporting3#mmAuthority
 * RegulatoryReporting3.mmAuthority}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msgpart.RegulatoryReporting3#mmDetails
...
public class RegulatoryReporting3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElements_lazy = LazyReference.create(() -> Arrays.asList(com.tools20022.repository.msgpart.RegulatoryReporting3.mmDebitCreditReportingIndicator, com.tools20022.repository.msgpart.RegulatoryReporting3.mmAuthority,
	...
	public Optional<RegulatoryReportingType1Code> getDebitCreditReportingIndicator() {
		return Optional.ofNullable(debitCreditReportingIndicator);
	}
