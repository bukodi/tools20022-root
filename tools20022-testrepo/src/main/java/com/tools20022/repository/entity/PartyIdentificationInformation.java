...
public class PartyIdentificationInformation {
	...
	public static final MMBusinessAssociationEnd mmOtherIdentification = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification5.mmOther, ContactDetails2.mmOther, OrganisationIdentification8.mmOther);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PartyIdentification43.mmIdentification, Party12Choice.mmParty);
				...
				derivationComponent_lazy = () -> Arrays.asList(Party11Choice.mmObject(), PartyIdentification43.mmObject(), Party12Choice.mmObject());
			}
