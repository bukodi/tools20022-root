...
public class PostalAddress extends ContactPoint {
	...
	public static final MMBusinessAttribute mmAddressType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress6.mmAddressType);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmStreetName = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress6.mmStreetName);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PostalAddress.mmObject();
	...
	public static final MMBusinessAttribute mmStreetBuildingIdentification = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress6.mmBuildingNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PostalAddress.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmPostCodeIdentification = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress6.mmPostCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PostalAddress.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmTownName = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress6.mmTownName, DateAndPlaceOfBirth.mmCityOfBirth);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PostalAddress.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "TownName";
	...
	public static final MMBusinessAttribute mmState = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress6.mmCountrySubDivision);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PostalAddress.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "State";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(FinancialInstitutionIdentification8.mmPostalAddress, BranchData2.mmPostalAddress, PartyIdentification43.mmPostalAddress);
