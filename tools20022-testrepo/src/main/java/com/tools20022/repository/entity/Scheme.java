...
public class Scheme {
	...
	public static final MMBusinessAttribute mmNameShort = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentificationSchemeName1Choice.mmProprietary);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialIdentificationSchemeName1Choice.mmCode, FinancialIdentificationSchemeName1Choice.mmProprietary, OrganisationIdentificationSchemeName1Choice.mmCode,
					OrganisationIdentificationSchemeName1Choice.mmProprietary, PersonIdentificationSchemeName1Choice.mmCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Scheme.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Code";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(FinancialIdentificationSchemeName1Choice.mmObject());
			}
