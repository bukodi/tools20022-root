...
public class ISODateTime extends MMDateTime {
	...
	private final static AtomicReference<ISODateTime> repoTypeRef = new AtomicReference<>();

	public static ISODateTime repoType() {
		repoTypeRef.compareAndSet(null, new ISODateTime());
