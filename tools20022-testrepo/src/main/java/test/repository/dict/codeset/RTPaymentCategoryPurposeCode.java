...
public class RTPaymentCategoryPurposeCode extends MMCodeSet {

	private final static AtomicReference<RTPaymentCategoryPurposeCode> repoTypeRef = new AtomicReference<>();

	public static RTPaymentCategoryPurposeCode repoType() {
		repoTypeRef.compareAndSet(null, new RTPaymentCategoryPurposeCode());
		return repoTypeRef.get();
	}

	private RTPaymentCategoryPurposeCode() {
	...
	static public class IntraCompanyPayment extends MMCode {
		...
		private IntraCompanyPayment() {
			super.owner_lazy = () -> RTPaymentCategoryPurposeCode.repoType();
			super.codeName = "INTC";
