...
public class RTCurrencyCode extends MMCodeSet {

	private final static AtomicReference<RTCurrencyCode> repoTypeRef = new AtomicReference<>();

	public static RTCurrencyCode repoType() {
		repoTypeRef.compareAndSet(null, new RTCurrencyCode());
		return repoTypeRef.get();
	}

	private RTCurrencyCode() {
