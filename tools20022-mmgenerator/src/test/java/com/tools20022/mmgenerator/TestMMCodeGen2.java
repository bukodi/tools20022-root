...
public class TestMMCodeGen2 {
	...
	public void testGerateMMClasses() throws Exception {
		...
		fileManager.dontChangeIfExists(p -> p.toString().contains( File.separator + "constraints" + File.separator ) || p.toString().contains(File.separator + "derived" + File.separator )  || p.toString().contains(File.separator + "ext" + File.separator ) || p.toString().contains(File.separator + "tools20022" + File.separator + "metamodel" + File.separator ) );
		...
		genCtx.generate(metamodel, new DefaultMetamodelGenerator2(genCtx), monitor);
	}
